...
public class ForgetPWD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/forgot-password.png"))); // NOI18N
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
            if(jTextField3.getText().equals("")){
            ...
            }else if(jPasswordField1.getText().equals("")){ //FOR VALIDATION
               JOptionPane.showMessageDialog(this,"Please Enter New Password");
           }else if(jPasswordField2.getText().equals("")){ //FOR VALIDATION
             ...
             boolean b = service.ForgetPWDService.passwordUpdate(jTextField3.getText(),jPasswordField1.getText());
                if(b){
